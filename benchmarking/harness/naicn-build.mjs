#!/usr/bin/env node
// Builder for NAIR-CN-v0.1 second-agent annotations.
// Computes offsets programmatically; verifies text === slice(start,end).
//
// Usage: node benchmarking/harness/naicn-build.mjs <specModulePath> <outPath>
//
...
const IDX = JSON.parse(
  readFileSync("benchmarking/suites/NAIR-CN-v0.1/model-input/document-index.json", "utf8"),
);
